...
for i in range(8):
    path_json = r"C:\Users\user\Desktop\project\dfdc_train_part_5"+str(i)+"\metadata.json"
    path_csv = r"C:\Users\user\Desktop\project\dfdc_train_part_5"+str(i)+"\metadata.csv"
    print(path_csv)
    print(path_json)
